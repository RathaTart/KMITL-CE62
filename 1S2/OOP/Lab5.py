...
class Enroll:
    def __init__(self, enroll_student, enroll_subject):
        self.__enroll_student = enroll_student
        self.__enroll_subject = enroll_subject
        self.__enroll_grade = None
    @property
    def enroll_student(self):
        return self.__enroll_student
    
    @enroll_student.setter
    def enroll_student(self, enroll_student):
        self.__enroll_student = enroll_student

    @property
    def enroll_subject(self):
        return self.__enroll_subject
    
    @enroll_subject.setter
    def enroll_subject(self, enroll_subject):
        self.__enroll_subject = enroll_subject

    @property
    def enroll_grade(self):
        return self.__enroll_grade
    
    @enroll_grade.setter
    def enroll_grade(self, enroll_grade):
        self.__enroll_grade = enroll_grade
...
def enroll_to_subject(student, subject):
    if not (isinstance(student, Student) and isinstance(subject, Subject)):
        return "Error"
    for set_enroll in enrollment_list:
        if student.student_id == set_enroll.enroll_student.student_id and subject.subject_id == set_enroll.enroll_subject.subject_id:
...
def drop_from_subject(student, subject):
    ...
    for set_enroll in enrollment_list:
        if student.student_id == set_enroll.enroll_student.student_id and subject.subject_id == set_enroll.enroll_subject.subject_id:
            enrollment_list.remove(set_enroll)
            return "Done"   
    return "Not Found"      
...
def search_student_enroll_in_subject(subject):
    ...
    if not (isinstance(subject, Subject)):
        return "Error"
    for set_enroll in enrollment_list:
        if subject.subject_id == set_enroll.enroll_subject.subject_id:
            list.append(set_enroll)
    return list 
...
def search_subject_that_student_enrolled(student):
    ...
    if not (isinstance(student, Student)):
        return "Error"
    for set_enroll in enrollment_list:
        if student.student_id == set_enroll.enroll_student.student_id:
            list.append(set_enroll)
    return list 
...
def assign_grade(student, subject, grade):
    if not (isinstance(student, Student) and isinstance(subject, Subject) and isinstance(grade, str)):
        return "Error"    
    for set_enroll in enrollment_list:
        if set_enroll.enroll_student == student and set_enroll.enroll_subject == subject:
            set_enroll.enroll_grade = grade
            return "Done"
    return "Not Found"
...
def get_student_record(student):
    record = {}
    for set_enroll in enrollment_list:
        if student == set_enroll.enroll_student:
            record[set_enroll.enroll_subject.subject_id] = [set_enroll.enroll_subject.subject_name, set_enroll.enroll_grade]
    return record
...
def list_student_enrolled_in_subject(subject_id):
    ...
    for enrollment in filter_student_list:
        student_dict[enrollment.enroll_student.student_id] = enrollment.enroll_student.student_name
    return student_dict
...
print([i.enroll_student.student_id for i in lst])
print("")
...
print([i.enroll_subject.subject_id for i in lst])
print("")
...
print(enroll.enroll_subject.subject_id,enroll.enroll_student.student_id)
print("")
