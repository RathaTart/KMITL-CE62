class User:
    ...
    def transactions_of_account(user):
        for user in user.account_list:
            print("")
            print("Accout No. : ",user.account_no)
            for transaction in user.transaction_list:
...
class Account:
    ...
    def __add__(self, amount_in):
        self.__amount += amount_in
        self.__transaction_list.append(Transaction("Deposit", amount_in, self.__amount, None))

    def __sub__(self, amount):
        self.__amount -= amount
        self.__transaction_list.append(Transaction("Withdraw", amount, self.__amount, None))
    
    def __irshift__(self, tuple_amount_targetAccount) :
        amount = tuple_amount_targetAccount[0] 
        # instance account
        target_account = tuple_amount_targetAccount[1]
        ...
        self.__transaction_list.append(Transaction("out_tranfer", amount, self.__amount, target_account))
        target_account.__transaction_list.append(Transaction("come_tranfer", amount, target_account.__amount, self))
...
print("Test Case #6")
print(hermione.transactions_of_account())