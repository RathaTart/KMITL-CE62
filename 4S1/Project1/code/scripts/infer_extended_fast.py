"""Run the opt-in accelerated primary pipeline on any remote image and description.
...
if need_lisa:run([L,'scripts/run_fast_lisa.py','--phase','lisa','--out-dir',str(a.out),'--max-new-tokens','16','--sam-encoder-device','cuda','--save-vis','0'])
else:
